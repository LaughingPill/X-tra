...
async def _(event):
    ...
    packname = f"@Laughing_pill 's kang pack O_o"
    packshortname = f"LPanxzstickers"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        if userid == 719877937:
            packshortname = "LaughingPill_Animated"
        else:
    ...
    await event.edit("`See Someone is doing Netflix Giveaway at Another channel!!Meanwhile lemme kang this stcker over hehe 0.0`")
